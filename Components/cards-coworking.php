<section class="cards-coworking container-lg d-flex justify-content-center flex-column">
	...
	<div class="cards-coworking__cards d-flex">
		...
		<div class="cards-coworking__container">
			<!-- <div class="row"> -->
				...
				<div class="cards-coworking__cards-img d-flex flex-wrap position-relative ">
					...
					<div class="cards-coworking__cards-backside position-absolute text-white d-flex flex-column overflow-hidden shadow-lg">
				...
				<div class="cards-coworking__cards-img d-flex flex-wrap position-relative overflow-hidden">

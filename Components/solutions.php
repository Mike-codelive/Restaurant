<section class="solutions container-lg px-5 mb-5">
	...
	<div class="solutions__collapse d-none d-md-flex h-100" id="cards">
		<p class="solutions__collapse-buttons">
		...
		<div class="solutions__collapse-card row mx-0" id="cards">
			<div class="col position-relative">
				...
				<div class="collapse multi-collapse" id="multiCollapseExample2" data-bs-parent="#cards">
					<div class="card card-body border-0">
						<img class="mb-5" src="<?php echo get_theme_file_uri('/images/bread.jpg') ?>" alt="coworking-space">
				...
				<div class="collapse multi-collapse" id="multiCollapseExample3" data-bs-parent="#cards">
					<div class="card card-body border-0">
						<img class="mb-5" src="<?php echo get_theme_file_uri('/images/bread.jpg') ?>" alt="On-Demand access">
						<p class="text-secondary mb-3 ">Lorem ipsum dolor sit amet consectetur adipisicing, elit. Officia temporibus dignissimos sapiente vero ut blanditiis vel eligendi quasi rem nemo molestiae maxime sint quas, iusto.</p>
						<button type="button" class="btn shadow-none border-0 bg-transparent flex-grow-0 py-0 d-flex align-items-center align-self-center text-center">View All Solutions <span class="material-icons-outlined mx-3">
							chevron_right
						</span></button>
				...
				<div class="collapse multi-collapse" id="multiCollapseExample4" data-bs-parent="#cards">
					<div class="card card-body border-0">
						<img class="mb-5" src="<?php echo get_theme_file_uri('/images/bread.jpg') ?>" alt="event space">
						<p class="text-secondary mb-3 ">Lorem ipsum dolor sit amet consectetur adipisicing, elit. Officia temporibus dignissimos sapiente vero ut blanditiis vel eligendi quasi rem nemo molestiae maxime sint quas, iusto.</p>
						<button type="button" class="btn shadow-none border-0 bg-transparent flex-grow-0 py-0 d-flex align-items-center align-self-center text-center">View All Solutions <span class="material-icons-outlined mx-3">
							chevron_right
						</span></button>

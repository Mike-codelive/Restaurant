<section class="cowork" id="cowork">

	<div class="position-relative container-lg d-flex justify-content-center flex-column">
		...
		<div class="d-flex">
			...
			<div class="cowork__pag d-flex justify-content-between align-items-center">
				<div class="cowork__pag-bar text-black-50">
					<span></span>
				</div>
				<p><span>01</span>/04</p>
			</div>
			...
			<div class="cowork__container">
				<div class="cowork__card d-flex flex-wrap position-relative ">
					...
					<div class="cowork__card-back position-absolute text-white d-flex flex-column overflow-hidden shadow-lg">
						...
						<button type="button" class="btn  shadow-none border-0 px-md-4 align-self-end p-3 ps-5 fw-light d-flex position-absolute">More <span class="material-icons-outlined">
							arrow_forward
						</span> </button>
					</div>
				</div>
				...
				<div class="cowork__card d-flex flex-wrap position-relative">
					...
					<div class="cowork__card-back position-absolute text-white d-flex flex-column overflow-hidden shadow-lg">
						<h1 class="position-absolute">02</h1>
						<div class="info text-center align-self-center fw-light position-absolute">
							<h2 class="fs-3">Private Space</h2>
							<h3 class="fs-6 fw-lighter">Move-in ready <br> office</h3>
						</div>
				...
				<div class="cowork__card d-flex flex-wrap position-relative overflow-hidden">
					...
					<div class="cowork__card-back position-absolute text-white d-flex flex-column overflow-hidden">
						<h1 class="position-absolute">03</h1>
						<div class="info text-center align-self-center fw-light position-absolute">
							<h2 class="fs-3">Private Space</h2>
							<h3 class="fs-6 fw-lighter">Move-in ready <br> office</h3>
						</div>

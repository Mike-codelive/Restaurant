...
function register_scripts() {
    wp_register_script('vendors', RESTAURANT_DIR_URI . '/bundled-assets/vendors~scripts.8c53231443eb1a832602.js', [], filemtime( RESTAURANT_DIR_PATH . '/bundled-assets/styles.ffb499273f47bd91eae3.css'), true);
    wp_register_script('restaurant', RESTAURANT_DIR_URI . '/bundled-assets/scripts.ffb499273f47bd91eae3.js', [], filemtime( RESTAURANT_DIR_PATH . '/bundled-assets/scripts.ffb499273f47bd91eae3.js'), true);
...
function register_styles() {
    ...
    wp_register_style('main-styles', RESTAURANT_DIR_URI . '/bundled-assets/styles.ffb499273f47bd91eae3.css', [], filemtime( RESTAURANT_DIR_PATH . '/bundled-assets/styles.ffb499273f47bd91eae3.css'));

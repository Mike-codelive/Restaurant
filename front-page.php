...
<!-- <section class='banner'>
  ...
  <div class="banner__header container-lg d-flex flex-column flex-lg-row justify-content-between px-3 px-lg-0">
    ...
    <p class="text-secondary align-self-md-center">Revolutionize you workspace. Whether you're an established enterprise or a growing startup, discover spaces that inspire you most impactful work.</p>
  </div>
  ...
  <?php echo get_theme_file_uri('/images/hero-1.jpg'); ?>"/>
